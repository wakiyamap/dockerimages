...
```
docker run -d --restart=no --name=pura -p 44444:44444 blocknetdx/pura:0.17.0.1 purad -daemon=0 -rpcuser=pura -rpcpassword=pura123
docker run -d --restart=on-failure:10 --name=pura -p 44444:44444 blocknetdx/pura:0.17.0.1 purad -daemon=0 -rpcuser=pura -rpcpassword=pura123
docker run -d --restart=unless-stopped --name=bitcoin -p 44444:44444 blocknetdx/pura:0.17.0.1 purad -daemon=0 -rpcuser=pura -rpcpassword=pura123
docker run -d --restart=always --name=bitcoin -p 44444:44444 blocknetdx/pura:0.17.0.1 purad -daemon=0 -rpcuser=pura -rpcpassword=pura123
```
